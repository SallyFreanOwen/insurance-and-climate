...
# Census data (cleaned from thesis project) importing  
...
mbCensusStats <- censusRaw[,c("mb2013", "Mean_Num_HH_Members_2013", "Median_HH_Income_2013", "Prop_Dwelling_Not_Owned_2013")]

rm(censusRaw)

names(mbCensusStats) <- c("mb2013", "meanNumHHMembers", "medianHHIncome", "propDwellingNotOwned")  # first name issue: 
