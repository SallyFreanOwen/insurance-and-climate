...
setwd("R:/Agriculture/Deep_South_Challenge_2017/Netcdf_observationsdata")
...
names(rain_df02) <- c("lon","lat", tdstr) # could rename variables to be rain on days 1-365 
...
csvname <- "rain_df_VCSN_Rain5k_1999.csv"
csvfile <- paste(csvname, sep="")
write.table(na.omit(rain_df02),csvfile, row.names=FALSE, sep=",")
