...
#setwd("R:/Agriculture/Deep_South_Challenge_2017/Raw Data/NIWA Climate projections/Precip")
...
openandsave <- function(ncname) {
  ...
  var_names <- rbind(lon, lat, time_values_df)
  ...
  csvfile <- paste("CSVs/", ncname, ".csv", sep="")
...
ncname = "Mon_TotalPrecipCorr_VCSN_BCC-CSM1.1_2006-2099_RCP6.0"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP2.6"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP4.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP8.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_CESM1-CAM5_2006-2100_RCP8.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP2.6"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP4.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP6.0"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GFDL-CM3_2006-2100_RCP2.6"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GFDL-CM3_2006-2100_RCP6.0"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GFDL-CM3_2006-2100_RCP8.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GFDL-CM3_2006-2120_RCP4.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GISS-EL-R_2006-2100_RCP6.0"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GISS-EL-R_2006-2120_RCP2.6"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GISS-EL-R_2006-2120_RCP4.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_GISS-EL-R_2006-2120_RCP8.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_HadGEM2-ES_2006-2099_RCP6.0"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_HadGEM2-ES_2006-2120_RCP2.6"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_HadGEM2-ES_2006-2120_RCP4.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_HadGEM2-ES_2006-2120_RCP8.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_NorESM1-M_2006-2100_RCP2.6"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_NorESM1-M_2006-2100_RCP4.5"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_NorESM1-M_2006-2100_RCP6.0"
openandsave(ncname)
ncname = "Mon_TotalPrecipCorr_VCSN_NorESM1-M_2006-2100_RCP8.5"
openandsave(ncname)
