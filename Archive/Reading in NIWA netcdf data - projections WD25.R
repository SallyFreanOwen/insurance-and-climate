# Extracting the WD25 Climate projections for the eqc project
# January 2018 
# Sally Owen 
...
openandsave <- function(ncname) {
  ...
  # Sense check - what size is this matrix? 
...
# set path and filename
#ncname <- "monSum_WD25PrecipCorr_VCSN_BCC-CSM1.1_1971-2005_RCPpast"
ncname <- "monSum_WD25PrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP2.6" 
openandsave(ncname)
ncname <- "monSum_WD25PrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP4.5" 
openandsave(ncname)
ncname <- "monSum_WD25PrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP6.0" 
openandsave(ncname)
ncname <- "monSum_WD25PrecipCorr_VCSN_BCC-CSM1.1_2006-2120_RCP8.5" 
openandsave(ncname)
#ncname <- "monSum_WD25PrecipCorr_VCSN_CESM1-CAM5_1971-2005_RCPpast"
ncname <- "monSum_WD25PrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP2.6" 
openandsave(ncname)
ncname <- "monSum_WD25PrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP4.5" 
openandsave(ncname)
ncname <- "monSum_WD25PrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP6.0" 
openandsave(ncname)
ncname <- "monSum_WD25PrecipCorr_VCSN_CESM1-CAM5_2006-2120_RCP8.5" 
openandsave(ncname)
#ncname <- "monSum_WD25PrecipCorr_VCSN_GFDL-CM3_1971-2005_RCPpast"  
ncname <- "monSum_WD25PrecipCorr_VCSN_GFDL-CM3_2006-2120_RCP2.6" 
openandsave(ncname)  
ncname <- "monSum_WD25PrecipCorr_VCSN_GFDL-CM3_2006-2120_RCP4.5"
openandsave(ncname)
